...
public class PedraPapelTesoura {
    public static void main (String[] args){
        ...
        for (int i = 0; i< N; i++){
            ...
            if (jogador1.equalsIgnoreCase("ataque") && jogador2.equalsIgnoreCase("ataque"))System.out.println("Aniquilicao mutua");
            else if (jogador1.equalsIgnoreCase("papel") && jogador2.equalsIgnoreCase("papel")) System.out.println("Empate");
